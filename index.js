...
function applyfilter(){
    ...
    const filterProducts=products.filter(products=>!category || products.category==category);
...
function displayProduct(products){
    ...
    products.forEach(product=>{
        ...
        localStorage.setItem('cardvalue',createProductCard)
    });
}
...
function createProductCard(product){
    ...
    button.addEventListener("submit",addcard)
    const cate=document.createElement('p')
    cate.textContent=product.category;
